...
volcanomap <- basemap %>% 
addCircleMarkers(lng = longitude, lat = latitude, popup = volcanonames, radius=3, color="red", stroke=FALSE, fillOpacity=1) # add a single point layer
...
volcanomap <- basemap %>% 
addCircles(lng = longitude, lat = latitude, popup = elevation, radius=10, color="blue", stroke=FALSE, fillOpacity=1) # add a single point layer
...
leaflet(data) %>%
   addTiles() %>%
  setView(-86.702, 12.506, zoom = 14) %>%
  addCircles(-86.702, 12.506, 
             radius = 500,
             color = "blue")
```
...
leaflet(data) %>% 
  addTiles() %>% 
  fitBounds(-155.608, 19.475, -155.287, 19.421) %>%
  addPolygons(c(-155.608, -155.589, -155.287),
