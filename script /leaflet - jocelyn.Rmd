...
leaflet(data = volcano) %>%
  addTiles() %>%
  addMarkers(lng = c(131.600, 140.281, 145.670, 145.030, 130.657),
             lat = c(34.500, 37.647, 18.770, 20.420, 31.593),
             icon = leafs)
```
...
leaflet(data = volcano) %>%
  addTiles() %>%
  addAwesomeMarkers(lng = c(131.600, 140.281, 145.670, 145.030, 130.657),
                    lat = c(34.500, 37.647, 18.770, 20.420, 31.593),
                    icon = volcano_icon)
```
